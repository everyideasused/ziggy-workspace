...
workout: "Day B2 — Lower (Posterior Chain)"
mesocycle: <% await tp.system.prompt("Mesocycle number") %>
week: <% await tp.system.prompt("Week number (1-4)") %>
session_number: 
kb_weight: 16
energy_level: 
sleep_hours: 
...
# <% tp.date.now("YYYY-MM-DD") %> — Day B2: Lower (Posterior Chain)
*Glutes · Hamstrings · Hip Power*
...
| Set | Target Reps | Actual (L) | Actual (R) | Weight (if adding KB) | Notes           |
| :-- | :---------- | :--------- | :--------- | :-------------------- | :-------------- |
...
> *Before closing: update frontmatter `session_rpe`, `protein_hit`, `water_hit`, `bodyweight`, `energy_level`, `sleep_hours`*
