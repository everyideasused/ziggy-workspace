...
async function authenticate() {
 ...
 console.log('3. You\'ll get an error about localhost redirect — that\'s OK');
 console.log('4. Look at the URL bar and copy the "code" parameter');
 console.log('   (It will look like: http://localhost:8888/callback?code=XXXXX&state=YYYYY)');
 console.log('\n');
