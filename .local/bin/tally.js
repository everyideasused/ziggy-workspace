...
exports.readKBNote = readKBNote;
exports.readMasterKB = readMasterKB;
exports.searchKB = searchKB;
exports.getProjectTypeKB = getProjectTypeKB;
exports.getWorkflowKB = getWorkflowKB;
exports.getBenchmarkKBs = getBenchmarkKBs;
exports.getRiskKBs = getRiskKBs;
exports.getTemplateKB = getTemplateKB;
exports.calculateEscalation = calculateEscalation;
exports.applyRegionalMultiplier = applyRegionalMultiplier;
exports.getContingencyByPhase = getContingencyByPhase;
exports.validateMEPPercentage = validateMEPPercentage;
exports.getTallyFullContext = getTallyFullContext;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const tally_memory_1 = require("./tally-memory");
// Paths
 ...
 */
function getProjectTypeKB(projectType) {
    const ptMap = {
 ...
 */
function getWorkflowKB(workflow) {
    const wfMap = {
 ...
 */
function getTemplateKB(templateType) {
    const tplMap = {
 ...
 */
function calculateEscalation(months, annualRate = 0.04) {
 ...
 */
function applyRegionalMultiplier(baseCost, multiplier) {
 ...
 */
function getContingencyByPhase(phase) {
    const phaseMap = {
 ...
 */
function validateMEPPercentage(mepCost, hardCost) {
